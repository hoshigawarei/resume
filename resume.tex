...
\datedsubsection{\textbf{NIO Inc. (a leading New Energy Vehicle manufacturer)}}{Mar. 2025 -- Present}
\role{Algorithm Development Intern}{Manager: Ugur Ersoy}
Overview: Developed and deployed an AI-based defect detection system using YOLOv11 and Feishu alerts to automate quality control in stamping workshops.
\begin{itemize}
  \item Built and deployed a YOLOv11-based defect detection system, integrating factory video streams with Feishu for real-time abnormality alerts.  
  \item Led full-cycle development, from model training to system integration and cloud deployment.
  \item Achieved 99.05\% precision and 90.00\% recall on validation data, reducing manual inspection time by 70\% and defect oversight by 45\%.
\end{itemize}

\datedsubsection{\textbf{Helmholtz Centre for Infection Research (HZI)} Germany (Remote)}{Dec. 2023 -- Present}
\role{Daily Intern}{Supervisor: Prof. Till Strowig \& Dr. Kun D. Huang}
